...
import { SaveConfigArgs, saveConfiguration } from "./actions";
...
const DesignConfigurator = ({
  ...
  const { mutate: saveConfig } = useMutation({
    ...
    mutationFn: async (args: SaveConfigArgs) => {
      await Promise.all([uploadCroppedImage(), saveConfiguration(args)]);
    },
    onError: (error) => {
      toast({
      ...
      errorLog("error saveConfig: ", error);
    },
    onSuccess: () => {
  ...
  const uploadCroppedImage = async () => {
    try {
      ...
      errorLog("uploadCroppedImage: ", error);
      toast({
        title: "Something went wrong",
